...
public class GestionJSONProducteur {
	 ...
	 */
	public static List<CategorieProducteur> lireJSON(String fichierJSON) {
		try {
			JsonReader reader = new JsonReader(new FileReader(fichierJSON));
			// On peut lire un seul objet ou un tableau avec []
			CategorieProducteur[] tabCat = new Gson().fromJson(reader, CategorieProducteur[].class);
