...
public class GestionJSONRole {
	 ...
	 */
	public static List<CategorieRole> lireJSON(String fichierJSON) {
		try {
			JsonReader reader = new JsonReader(new FileReader(fichierJSON));
			// On peut lire un seul objet ou un tableau avec []
			CategorieRole[] tabCat = new Gson().fromJson(reader, CategorieRole[].class);
