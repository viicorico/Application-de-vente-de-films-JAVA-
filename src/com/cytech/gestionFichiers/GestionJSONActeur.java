...
public class GestionJSONActeur {
	 ...
	 */
	public static List<CategorieActeur> lireJSON(String fichierJSON) {
		try {
			JsonReader reader = new JsonReader(new FileReader(fichierJSON));
			// On peut lire un seul objet ou un tableau avec []
			CategorieActeur[] tabCat = new Gson().fromJson(reader, CategorieActeur[].class);
